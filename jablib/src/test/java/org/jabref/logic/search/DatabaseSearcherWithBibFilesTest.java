...
class DatabaseSearcherWithBibFilesTest {
    ...
    private static final BibEntry MINIMAL_SENTENCE_CASE = new BibEntry(StandardEntryType.Misc)
            ...
            .withFiles(List.of(LinkedFile.Factory.fromString("", "minimal-sentence-case.pdf", StandardFileType.PDF.getName())));
    private static final BibEntry MINIMAL_ALL_UPPER_CASE = new BibEntry(StandardEntryType.Misc)
            ...
            .withFiles(List.of(LinkedFile.Factory.fromString("", "minimal-all-upper-case.pdf", StandardFileType.PDF.getName())));
    private static final BibEntry MINIMAL_MIXED_CASE = new BibEntry(StandardEntryType.Misc)
            .withCitationKey("minimal-mixed-case")
            .withFiles(List.of(LinkedFile.Factory.fromString("", "minimal-mixed-case.pdf", StandardFileType.PDF.getName())));
    private static final BibEntry MINIMAL_NOTE_SENTENCE_CASE = new BibEntry(StandardEntryType.Misc)
            ...
            .withFiles(List.of(LinkedFile.Factory.fromString("", "minimal-note-sentence-case.pdf", StandardFileType.PDF.getName())));
    private static final BibEntry MINIMAL_NOTE_ALL_UPPER_CASE = new BibEntry(StandardEntryType.Misc)
            ...
            .withFiles(List.of(LinkedFile.Factory.fromString("", "minimal-note-all-upper-case.pdf", StandardFileType.PDF.getName())));
    private static final BibEntry MINIMAL_NOTE_MIXED_CASE = new BibEntry(StandardEntryType.Misc)
            ...
            .withFiles(List.of(LinkedFile.Factory.fromString("", "minimal-note-mixed-case.pdf", StandardFileType.PDF.getName())));
