...
class BvbFetcherTest {
    ...
    BibEntry bibEntryISBN9783960886402 = new BibEntry(StandardEntryType.Misc)
            ...
            .withFiles(List.of(LinkedFile.Factory.fromFileType("", "http://search.ebscohost.com/login.aspx?direct=true&scope=site&db=nlebk&db=nlabk&AN=1906353", StandardFileType.PDF)))
